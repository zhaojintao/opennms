...
public class EnhancedLinkdTopologyProviderTest {
    ...
    public void testLoadSimpleGraph() throws Exception {
        ...
        assertEquals(true,v1.getProtocolSupported().contains(Topology.ProtocolSupported.LLDP));
        assertEquals(true,v1.getProtocolSupported().contains(Topology.ProtocolSupported.OSPF));
        assertEquals(false,v1.getProtocolSupported().contains(Topology.ProtocolSupported.CDP));
        assertEquals(false,v1.getProtocolSupported().contains(Topology.ProtocolSupported.ISIS));
        assertEquals(false,v1.getProtocolSupported().contains(Topology.ProtocolSupported.BRIDGE));
        LinkdVertex v2 = (LinkdVertex)m_topologyProvider.getVertex("nodes", "2");
        assertEquals(true,v2.getProtocolSupported().contains(Topology.ProtocolSupported.LLDP));
        assertEquals(true,v2.getProtocolSupported().contains(Topology.ProtocolSupported.OSPF));
        assertEquals(false,v2.getProtocolSupported().contains(Topology.ProtocolSupported.CDP));
        assertEquals(false,v2.getProtocolSupported().contains(Topology.ProtocolSupported.ISIS));
        assertEquals(false,v2.getProtocolSupported().contains(Topology.ProtocolSupported.BRIDGE));
        LinkdVertex v3 = (LinkdVertex)m_topologyProvider.getVertex("nodes", "3");
        assertEquals(true,v3.getProtocolSupported().contains(Topology.ProtocolSupported.LLDP));
        assertEquals(false,v3.getProtocolSupported().contains(Topology.ProtocolSupported.OSPF));
        assertEquals(false,v3.getProtocolSupported().contains(Topology.ProtocolSupported.CDP));
        assertEquals(false,v3.getProtocolSupported().contains(Topology.ProtocolSupported.ISIS));
        assertEquals(false,v3.getProtocolSupported().contains(Topology.ProtocolSupported.BRIDGE));
